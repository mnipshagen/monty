...
\begin{itemize}
\item[a)] aAb0hello \sol{Yes.}
\item[b)] x0hellohi \sol{No. It can only be either hi or hello.}
\item[c)] xyz0yhi \sol{No. There cannot be another single letter following the 0, only hi or hello.}
\item[d)] 0hi \sol{Yes.}
\end{itemize}
